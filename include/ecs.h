...
#define entity_remove_component(ENTITY, COMPONENT) _entity_remove_component_impl((ENTITY), re_str_lit(#COMPONENT))
...
extern void _entity_remove_component_impl(entity_t ent, re_str_t component);
